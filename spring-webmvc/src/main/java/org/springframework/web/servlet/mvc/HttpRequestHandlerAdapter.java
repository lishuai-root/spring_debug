...
/**
 * 用于处理实现了{@link HttpRequestHandler}接口的处理程序
 *
 ...
 * 适配器使用普通的{@link org.springframework.web.HttpRequestHandler}与通用的{@link org.springframework.web.servlet.DispatcherServlet}接口。
