...
public enum Autowire {
	...
	/**
	 * Constant that indicates no autowiring at all.	表示完全没有自动装配的常数。
	 */
	NO(AutowireCapableBeanFactory.AUTOWIRE_NO),

	/**
	 * Constant that indicates autowiring bean properties by name.	通过名称指示自动装配bean属性的常数。
	 */
	BY_NAME(AutowireCapableBeanFactory.AUTOWIRE_BY_NAME),

	/**
	 * Constant that indicates autowiring bean properties by type.	指示按类型自动装配bean属性的常数。
	 */
