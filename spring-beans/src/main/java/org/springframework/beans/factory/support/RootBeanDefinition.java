...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/**
	 * Specify a factory method name that refers to a non-overloaded method.	指定引用非重载方法的工厂方法名。
	 */
	...
	/**
	 * Specify a factory method name that refers to an overloaded method.	指定引用重载方法的工厂方法名。
	 * @since 5.2
	 */
	...
	/**
	 * Check whether the given candidate qualifies as a factory method.	检查给定的候选方法是否符合工厂方法的要求。
	 */
