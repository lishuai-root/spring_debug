...
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		 ...
		 * 分割base-package属性值
		 * eg:
		 * 		<context:component-scan base-package="com.shuai.beans,com.shuai.test"/>
		 * 		会被分割成String[] {"com.shuai.beans", "com.shuai.test"}
		 * 	分隔符支持：逗号，分行，制表符，换行
		 */
		...
		// 扫描包下所有beanDefinition
		Set<BeanDefinitionHolder> beanDefinitions = scanner.doScan(basePackages);
		// 注册相关的postProcessBeanDefinitionRegistry
		// 如果需要，ConfigurationClassPostProcessor类会在此处注册
